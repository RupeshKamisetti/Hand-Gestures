        ...
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            if len(landmark_list) >= 9:
                ...
                if (landmark_list[8][1] < landmark_list[6][1] and 
                    ...
                    gesture = "HEY! I'm Rupesh"
                if (landmark_list[4][1] > landmark_list[3][1] and 
                    landmark_list[8][1] < landmark_list[6][1]
                ):
                    gesture = "I'm an Artist"
                if gesture:
                    text_x = landmark_list[0][0]
                    text_y = landmark_list[0][1] - 30
                    cv2.putText(frame, gesture, (text_x, text_y), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA)
